...
if (clouds > 80) {
    ...
    if (humidity > 80) {
      ...
      gradient = 'linear-gradient(to bottom right, rgb(70, 50, 60), rgb(60, 45, 55), rgb(50, 40, 50), rgb(40, 35, 45), rgb(30, 30, 40))';
    } else {
      color = 'Dull Mauve';
      ...
      gradient = 'linear-gradient(to bottom right, rgb(110, 90, 100), rgb(100, 85, 95), rgb(90, 80, 90), rgb(80, 75, 85))';
    }
    ...
    if (humidity > 70) {
      ...
      gradient = 'linear-gradient(to bottom left, rgb(210, 160, 150), rgb(190, 140, 130), rgb(170, 120, 110), rgb(150, 100, 90))';
    } else {
      color = 'Muted Orange';
      ...
      gradient = 'linear-gradient(to bottom left, rgb(255, 179, 166), rgb(245, 155, 140), rgb(235, 140, 120), rgb(225, 125, 100))';
    }
    ...
    if (humidity > 60) {
      ...
      gradient = 'linear-gradient(to bottom right, rgb(255, 200, 220), rgb(255, 185, 205), rgb(255, 170, 190), rgb(255, 155, 175))';
    } else {
      color = 'Pastel Pink';
      ...
      gradient = 'linear-gradient(to bottom left, rgb(255, 221, 240), rgb(255, 200, 220), rgb(255, 180, 200), rgb(255, 157, 172))';
    }
